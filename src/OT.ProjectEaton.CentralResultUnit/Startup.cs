...
using OT.ProjectEaton.CentralResultUnit.Options;
...
namespace OT.ProjectEaton.CentralResultUnit
{
    public class Startup
    {
        ...
        {
            var mongoConfigs = new MongoConfigs();
            Configuration.Bind(nameof(mongoConfigs), mongoConfigs);
